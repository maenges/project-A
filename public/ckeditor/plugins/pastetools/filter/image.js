...
(function () {
  function u(a, c, b) {
    ...
    if (b.length !== e.length)
      return (
        CKEDITOR.error('pastetools-failed-image-extraction', { rtf: c.length, html: b.length }),
        a
      );
  ...
  function h(a) {
    var c =
        -1 !==
        CKEDITOR.tools.array.indexOf(CKEDITOR.pasteFilters.image.supportedImageTypes, a.type),
      b = a.hex;
    if (!c) return null;
