    ...
    bender.test({
      ...
      'test notifications and progress steps are correct in happy path': function () {
        ...
        a.once('exportPdf', function () {
          c(a, { message: 'Processing PDF document...', type: 'progress', progress: 0 });
        });
        a.once(
          'exportPdf',
          function () {
            c(a, { message: 'Processing PDF document...', type: 'progress', progress: 0.2 });
          },
          null,
          null,
          16
        ...
        exportPdfUtils.useXHR(a, function (b) {
          b.addEventListener('progress', function () {
            c(a, { message: 'Processing PDF document...', type: 'progress', progress: 0.8 });
          });
          b.addEventListener('loadend', function () {
            c(a, { message: 'Document is ready!', type: 'success', progress: 1 });
          });
          b.respond(200, {}, '');
        });
      },
      'test notifications and progress steps are correct in sad path': function () {
        ...
        exportPdfUtils.useXHR(a, function (b) {
          var d = sinon.stub(console, 'error', function (a) {
            assert.areSame('Validation failed.', a.message, 'Message from endpoint is incorrect.');
            d.restore();
          });
          b.addEventListener('loadend', function () {
