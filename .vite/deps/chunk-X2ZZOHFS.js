...
import { FormControlContext_default, useFormControl } from './chunk-R4FCYQTX.js';
...
import { globalCss, useDefaultProps } from './chunk-KVEJKEZ5.js';
import { getOverlayAlpha, styled_default, useTheme } from './chunk-SCZ4OLDJ.js';
import {
  alpha,
  chainPropTypes,
  composeClasses,
...
var TextareaAutosize = React2.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  const { current: isControlled } = React2.useRef(value != null);
...
true
  ? (TextareaAutosize.propTypes = {
       ...
       */
      maxRows: import_prop_types2.default.oneOfType([
       ...
       * @default 1
       */
      minRows: import_prop_types2.default.oneOfType([
        import_prop_types2.default.number,
        import_prop_types2.default.string,
      ]),
      /**
       ...
       * @ignore
       */
      value: import_prop_types2.default.oneOfType([
...
var InputBase = React3.forwardRef(function InputBase2(inProps, ref) {
  ...
  const { current: isControlled } = React3.useRef(value != null);
  ...
  const checkDirty = React3.useCallback(
    (obj) => {
      if (isFilled(obj)) {
        if (onFilled) {
          onFilled();
  ...
  return (0, import_jsx_runtime3.jsxs)(React3.Fragment, {
    children: [
      !disableInjectingGlobalStyles &&
        typeof InputGlobalStyles === 'function' && // For Emotion/Styled-components, InputGlobalStyles will be a function
        // For Pigment CSS, this has no effect because the InputGlobalStyles will be null.
        (_InputGlobalStyles ||
          (_InputGlobalStyles = (0, import_jsx_runtime3.jsx)(InputGlobalStyles, {}))),
      (0, import_jsx_runtime3.jsxs)(Root, {
        ...rootProps,
        ref,
        onClick: handleClick,
        ...other,
        ...
        children: [
          startAdornment,
          (0, import_jsx_runtime3.jsx)(FormControlContext_default.Provider, {
            value: null,
...
true
  ? (InputBase.propTypes = {
       ...
       */
      color: import_prop_types3.default.oneOfType([
        import_prop_types3.default.oneOf([
          'primary',
          'secondary',
          'error',
          'info',
       ...
       */
      maxRows: import_prop_types3.default.oneOfType([
       ...
       */
      minRows: import_prop_types3.default.oneOfType([
        import_prop_types3.default.number,
        import_prop_types3.default.string,
      ]),
      /**
       ...
       */
      rows: import_prop_types3.default.oneOfType([
        import_prop_types3.default.number,
        import_prop_types3.default.string,
      ]),
      /**
       ...
       */
      size: import_prop_types3.default.oneOfType([
        import_prop_types3.default.oneOf(['medium', 'small']),
        import_prop_types3.default.string,
      ]),
      /**
       * The extra props for the slot components.
...
var ArrowDropDown_default = createSvgIcon(
...
//# sourceMappingURL=chunk-X2ZZOHFS.js.map
