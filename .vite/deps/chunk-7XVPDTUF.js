...
import { createSvgIcon, unsupportedProp_default } from './chunk-TLMSET2H.js';
...
var Cancel_default = createSvgIcon(
    ...
    return [
      ...
      },
      {
        [`& .${chipClasses_default.deleteIcon}`]:
          styles[`deleteIconColor${capitalize_default(color)}`],
      },
      {
        [`& .${chipClasses_default.deleteIcon}`]:
          styles[`deleteIcon${capitalize_default(variant)}Color${capitalize_default(color)}`],
      },
      styles.root,
...
var Chip = React2.forwardRef(function Chip2(inProps, ref) {
  ...
  if (onDelete) {
    deleteIcon =
      deleteIconProp && React2.isValidElement(deleteIconProp)
        ? React2.cloneElement(deleteIconProp, {
  ...
  return (0, import_jsx_runtime2.jsxs)(ChipRoot, {
    ...
    children: [
      avatar || icon,
      (0, import_jsx_runtime2.jsx)(ChipLabel, {
...
true
  ? (Chip.propTypes = {
      ...
      variant: import_prop_types.default.oneOfType([
        import_prop_types.default.oneOf(['filled', 'outlined']),
        import_prop_types.default.string,
      ]),
    })
  : void 0;
...
export { getChipUtilityClass, chipClasses_default, Chip_default };
//# sourceMappingURL=chunk-7XVPDTUF.js.map
