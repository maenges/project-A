import { Backdrop_default, Modal_default } from './chunk-O7XXZBRM.js';
import { Fade_default } from './chunk-DRP53DCM.js';
import { Paper_default } from './chunk-X2ZZOHFS.js';
...
true
  ? (Dialog.propTypes = {
      ...
      'aria-modal': import_prop_types.default.oneOfType([
        import_prop_types.default.oneOf(['false', 'true']),
      ...
      maxWidth: import_prop_types.default.oneOfType([
        import_prop_types.default.oneOf(['xs', 'sm', 'md', 'lg', 'xl', false]),
...
var DialogContent = React3.forwardRef(function DialogContent2(inProps, ref) {
  ...
  return (0, import_jsx_runtime2.jsx)(DialogContentRoot, {
    className: clsx_default(classes.root, className),
    ownerState,
    ref,
    ...other,
...
//# sourceMappingURL=chunk-BBFLCO4T.js.map
