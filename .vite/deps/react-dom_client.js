    ...
    (function () {
      ...
      function handleTimeout(currentTime) {
        ...
        if (!isHostCallbackScheduled)
          if (null !== peek(taskQueue)) ((isHostCallbackScheduled = true), requestHostCallback());
          else {
            var firstTimer = peek(timerQueue);
            null !== firstTimer &&
              requestHostTimeout(handleTimeout, firstTimer.startTime - currentTime);
    ...
    (function () {
      ...
      function markSpawnedDeferredLane(root2, spawnedLane, entangledLanes) {
        ...
        root2.entanglements[spawnedLaneIndex] =
          root2.entanglements[spawnedLaneIndex] | 1073741824 | (entangledLanes & 4194218);
      }
      ...
      function updateOffscreenComponent(current2, workInProgress2, renderLanes2) {
        var nextProps = workInProgress2.pendingProps,
          ...
          nextIsDetached = 0 !== (workInProgress2.stateNode._pendingVisibility & OffscreenDetached),
      ...
      function markRef(current2, workInProgress2) {
        ...
        if (null === ref)
          ...
          if (null === current2 || current2.ref !== ref) workInProgress2.flags |= 2097664;
        }
      }
      ...
      function updateClassComponent(
        ...
        if (lane || state) {
          ...
          null !== current$jscomp$0 && state
            ...
            : reconcileChildren(current$jscomp$0, workInProgress2, Component, renderLanes2);
      ...
      function updateSuspenseComponent(current2, workInProgress2, renderLanes2) {
        ...
        JSCompiler_object_inline_digest_2317 &&
          ((JSCompiler_object_inline_componentStack_2319 = true), (workInProgress2.flags &= -129));
        ...
        if (null === current2) {
          if (isHydrating) {
            ...
            if (isHydrating) {
              ...
              JSCompiler_temp &&
                (warnNonHydratedInstance(workInProgress2, JSCompiler_object_inline_message_2316),
          ...
          if (JSCompiler_object_inline_componentStack_2319)
            return (
              reuseSuspenseHandlerOnStack(workInProgress2),
              (JSCompiler_object_inline_componentStack_2319 = workInProgress2.mode),
              ...
              (JSCompiler_object_inline_componentStack_2319 = workInProgress2.child),
        ...
        if (
          ...
          if (didSuspend)
            workInProgress2.flags & 256
              ...
              : null !== workInProgress2.memoizedState
                ...
                : (reuseSuspenseHandlerOnStack(workInProgress2),
                  ...
                  (JSCompiler_object_inline_stack_2318.return = workInProgress2),
                  (JSCompiler_object_inline_componentStack_2319.return = workInProgress2),
                  ...
                  (workInProgress2.memoizedState = SUSPENDED_MARKER),
                  (workInProgress2 = JSCompiler_object_inline_componentStack_2319));
          else if (
            (pushPrimaryTreeSuspenseHandler(workInProgress2),
            isHydrating &&
              console.error(
            ...
            (JSCompiler_object_inline_digest_2317 = 0 !== (renderLanes2 & current2.childLanes)),
            ...
            if (null !== JSCompiler_object_inline_digest_2317) {
              ...
              JSCompiler_object_inline_stack_2318 =
                0 !==
                (JSCompiler_object_inline_stack_2318 &
                  (JSCompiler_object_inline_digest_2317.suspendedLanes | renderLanes2))
                  ? 0
                  : JSCompiler_object_inline_stack_2318;
              if (
                ...
                throw (
                  ...
                  enqueueConcurrentRenderForLane(current2, JSCompiler_object_inline_stack_2318),
            ...
            JSCompiler_object_inline_message_2316.data === SUSPENSE_PENDING_START_DATA
              ? ((workInProgress2.flags |= 128),
                (workInProgress2.child = current2.child),
                (workInProgress2 = retryDehydratedSuspenseBoundary.bind(null, current2)),
                (JSCompiler_object_inline_message_2316._reactRetry = workInProgress2),
                (workInProgress2 = null))
        ...
        if (JSCompiler_object_inline_componentStack_2319)
          return (
            ...
            (JSCompiler_object_inline_componentStack_2319 = workInProgress2.child),
            (JSCompiler_object_inline_message_2316 = current2.child.memoizedState),
            null === JSCompiler_object_inline_message_2316
              ? (JSCompiler_object_inline_message_2316 = mountSuspenseOffscreenState(renderLanes2))
                ...
                if (
                  ...
                  for (
                    nextHydratableInstance = getNextHydratable(
                      ...
                      hydrationDiffRootDEV = null,
                      rootOrSingletonContext = true,
                      current2 = mountChildFibers(workInProgress2, null, nextProps, renderLanes2),
            ...
            return (
              ...
              null === current2 &&
                ...
                didSuspendOrErrorDEV ||
                  ...
                  null !== returnFiber &&
                    (buildHydrationDiffNode(workInProgress2, 0).serverProps = returnFiber)),
                (hydrationParentFiber = workInProgress2),
                (rootOrSingletonContext = true),
          ...
          case 5:
            return (
              null === current2 &&
                ...
                (returnFiber = validateDOMNesting(workInProgress2.type, nextProps.ancestorInfo)),
                  ...
                  null !== nextState
                    ? ((workInProgress2.stateNode = nextState),
                      didSuspendOrErrorDEV ||
                        ...
                        null !== nextProps &&
                          (buildHydrationDiffNode(workInProgress2, 0).serverProps = nextProps)),
                      (hydrationParentFiber = workInProgress2),
          ...
          case 6:
            return (
              null === current2 &&
                ...
                (current2 =
                  null != renderLanes2 ? validateTextNesting(current2, renderLanes2.tag) : true),
              ...
              null === current2
                ? ((prevSibling = peekCacheFromPool()),
                  null === prevSibling &&
                    ...
                    null !== nextProps && (prevSibling.pooledCacheLanes |= renderLanes2),
                            ...
                            for (var i = 0; i < maybeNodes.length; i++)
                              if (
                                ...
                                hoistableRoot.getAttribute('href') ===
                                  (null == current2.href ? null : current2.href) &&
        ...
        switch (workInProgress2.tag) {
              ...
              if (popHydrationState(workInProgress2)) {
                ...
                if (null !== returnFiber)
                  switch (returnFiber.tag) {
                    case 3:
                      _type &&
                        ((_type = diffHydratedTextForDevWarnings(current2, newProps, renderLanes2)),
                        null !== _type &&
                ...
                current2 =
                  ...
                  (null !== renderLanes2 && true === renderLanes2.suppressHydrationWarning) ||
                ...
                ((renderLanes2 = renderLanes2.ancestorInfo.current),
                  null != renderLanes2 && validateTextNesting(newProps, renderLanes2.tag),
          ...
          case 23:
            return (
              ...
              null !== newProps && scheduleRetryEffect(workInProgress2, newProps.retryQueue),
              (newProps = null),
              null !== current2 &&
                null !== current2.memoizedState &&
                null !== current2.memoizedState.cachePool &&
      ...
      function scheduleUpdateOnFiber(root2, fiber, lane) {
        ...
        if (
          (root2 === workInProgressRoot && workInProgressSuspendedReason === SuspendedOnData) ||
      ...
      function performWorkOnRoot(root2, lanes, forceSync) {
        ...
        var shouldTimeSlice =
            (!forceSync && 0 === (lanes & 60) && 0 === (lanes & root2.expiredLanes)) ||
      ...
      function flushPassiveEffects() {
        if (null !== rootWithPendingPassiveEffects) {
          ...
          try {
            ...
            ReactSharedInternals.T = null;
            if (null === rootWithPendingPassiveEffects) var JSCompiler_inline_result = false;
            else {
      ...
      function ensureRootIsScheduled(root2) {
        ...
        null !== ReactSharedInternals.actQueue
          ...
          : didScheduleMicrotask ||
            ((didScheduleMicrotask = true), scheduleImmediateTask(processRootScheduleInMicrotask));
      }
              ...
              if (!onlyLegacy)
                if (0 !== syncTransitionLanes) {
                  ...
                  ((nextLanes = workInProgressRootRenderLanes),
                    (nextLanes = getNextLanes(root2, root2 === workInProgressRoot ? nextLanes : 0)),
                    0 === (nextLanes & 3) ||
      ...
      function scheduleTaskForRootDuringMicrotask(root2, currentTime) {
        ...
        if (
          0 === suspendedLanes ||
          (root2 === currentTime && workInProgressSuspendedReason === SuspendedOnData) ||
          null !== root2.cancelPendingCommit
        )
          return (
      ...
      function performWorkOnRootViaSchedulerTask(root2, didTimeout) {
        ...
        if (flushPassiveEffects() && root2.callbackNode !== originalCallbackNode) return null;
                ...
                runWithPriority(queuedTarget.priority, function () {
                  if (13 === nearestMounted.tag) {
                    var lane = requestUpdateLane(nearestMounted),
                      root2 = enqueueConcurrentRenderForLane(nearestMounted, lane);
