...
import { rootShouldForwardProp_default, styled_default } from './chunk-SCZ4OLDJ.js';
import {
  composeClasses,
...
var FormLabel = React.forwardRef(function FormLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime.jsxs)(FormLabelRoot, {
    ...
    children: [
      children,
      fcs.required &&
        (0, import_jsx_runtime.jsxs)(AsteriskComponent, {
          ownerState,
          'aria-hidden': true,
...
true
  ? (InputLabel.propTypes = {
      ...
      size: import_prop_types2.default.oneOfType([
        import_prop_types2.default.oneOf(['normal', 'small']),
        import_prop_types2.default.string,
      ]),
      /**
       * The system prop that allows defining system overrides as well as additional CSS styles.
...
var TextField = React3.forwardRef(function TextField2(inProps, ref) {
  ...
  return (0, import_jsx_runtime3.jsxs)(RootSlot, {
    ...
    children: [
      label != null &&
        label !== '' &&
        (0, import_jsx_runtime3.jsx)(InputLabelSlot, {
          htmlFor: id,
          id: inputLabelId,
          ...inputLabelProps,
          children: label,
      ...
      select
        ? (0, import_jsx_runtime3.jsx)(SelectSlot, {
            'aria-describedby': helperTextId,
            id,
        ...
        : InputElement,
      helperText &&
        (0, import_jsx_runtime3.jsx)(FormHelperTextSlot, {
          id: helperTextId,
          ...formHelperTextProps,
          children: helperText,
        }),
...
true
  ? (TextField.propTypes = {
      ...
      slotProps: import_prop_types3.default.shape({
        formHelperText: import_prop_types3.default.oneOfType([
          import_prop_types3.default.func,
          import_prop_types3.default.object,
        ]),
        htmlInput: import_prop_types3.default.oneOfType([
          import_prop_types3.default.func,
          import_prop_types3.default.object,
        ]),
        input: import_prop_types3.default.oneOfType([
          import_prop_types3.default.func,
          import_prop_types3.default.object,
        ]),
        inputLabel: import_prop_types3.default.oneOfType([
          import_prop_types3.default.func,
          import_prop_types3.default.object,
        ]),
        select: import_prop_types3.default.oneOfType([
          import_prop_types3.default.func,
          import_prop_types3.default.object,
        ]),
      }),
...
//# sourceMappingURL=chunk-KIUXAB3T.js.map
