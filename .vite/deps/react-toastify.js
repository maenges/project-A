...
function gt({
  ...
  let C = clsx_default(
    ...
    S = P(l) ? l({ rtl: c, type: r, defaultClassName: C }) : clsx_default(C, l),
    E = {
...
y.update = (t, o = {}) => {
  ...
  if (e) {
    let { props: r, content: s } = e,
      l = { delay: 100, ...r, ...o, toastId: o.toastId || t, updateId: at() };
...
function At(t) {
  let [o, e] = (0, import_react8.useState)(false),
    [r, s] = (0, import_react8.useState)(false),
...
function Nt({ theme: t, type: o, isLoading: e, icon: r }) {
  ...
  return (
    r === false ||
      (P(r)
        ? (s = r({ ...l, isLoading: e }))
        : (0, import_react11.isValidElement)(r)
          ? (s = (0, import_react11.cloneElement)(r, l))
          : e
            ? (s = W.spinner())
            : lo(o) && (s = W[o](l))),
    s
...
var wt = (t) => {
  ...
  return (
    ...
    import_react10.default.createElement(
      C,
      { isIn: _, done: m, position: S, preventExitTransition: e, nodeRef: r, playToast: l },
      import_react10.default.createElement(
        'div',
        {
          id: h,
...
function Lt(t) {
  let o = { ..._o, ...t },
    e = t.stacked,
    [r, s] = (0, import_react6.useState)(true),
  ...
  return (
    ...
    (0, import_react6.useEffect)(() => {
      function f(p) {
        ...
        let b = l.current;
        (C(p) &&
          ((i = b.querySelector('[tabIndex="0"]')) == null || i.focus(), s(false), y.pause()),
          p.key === 'Escape' &&
