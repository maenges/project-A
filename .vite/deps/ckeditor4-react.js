  ...
  return new Promise(function (scriptResolve, scriptReject) {
    loadScript(editorURL, function (err) {
      ...
      if (err) {
        ...
        return scriptReject(
          new Error("Script loaded from editorUrl doesn't provide CKEDITOR namespace.")
        );
      }
...
var CKEditorEventAction = __spreadArray(
  __spreadArray([], events, true),
  namespaceEvents,
  true
).reduce(function (acc, evtName) {
  var _a;
...
function useCKEditor(_a) {
  var config = _a.config,
    ...
    element = _a.element,
    initContent = _a.initContent,
    _c = _a.type,
    type = _c === void 0 ? 'classic' : _c;
  var editorUrlRef = useRef$1(editorUrl || defEditorUrl);
  var subscribeToRef = useRef$1(
    subscribeTo !== null && subscribeTo !== void 0 ? subscribeTo : defaultEvents
  );
      ...
      if (element && !editor) {
        ...
        var onNamespaceLoaded = function (CKEDITOR2) {
          ...
          if (subscribeToRef.current.indexOf('namespaceLoaded') !== -1) {
            (_a2 = dispatchEventRef.current) === null || _a2 === void 0
              ? void 0
              : _a2.call(dispatchEventRef, {
          ...
          subscribedEditorEvents.forEach(function (evtName) {
            registerEditorEventHandler({
              ...
              handler: function (payload) {
                var _a3;
                (_a3 = dispatchEventRef.current) === null || _a3 === void 0
                  ? void 0
                  : _a3.call(dispatchEventRef, {
...
function CKEditor(_a) {
  ...
  return React.createElement(
    'div',
    {
      id: name !== null && name !== void 0 ? name : void 0,
      ref: setElement,
...
var propTypes = __assign(
  ...
  defaultEvents.reduce(function (acc, key) {
    ...
    return __assign(
      __assign({}, acc),
      ((_a = {}), (_a[eventNameToHandlerName(key)] = PropTypes.func), _a)
    );
  }, {})
);
