...
import { Popper_default } from './chunk-EEDGUGQ2.js';
import { Chip_default } from './chunk-7XVPDTUF.js';
import { useSlot } from './chunk-SCD7GONV.js';
import { createSvgIcon } from './chunk-TLMSET2H.js';
...
var defaultIsActiveElementInListbox = (listboxRef) => {
  ...
  return (
    ...
    ((_a = listboxRef.current.parentElement) == null ? void 0 : _a.contains(document.activeElement))
  );
};
...
function useAutocomplete(props) {
    ...
    if (typeof optionLabel !== 'string') {
      if (true) {
        const erroneousReturn =
          optionLabel === void 0 ? 'undefined' : `${typeof optionLabel} (${optionLabel})`;
        console.error(
  ...
  const setHighlightedIndex = useEventCallback_default(({ event, index, reason }) => {
...
var Autocomplete = React4.forwardRef(function Autocomplete2(inProps, ref) {
  ...
  const {
    ...
    clearIcon = _ClearIcon ||
      (_ClearIcon = (0, import_jsx_runtime3.jsx)(Close_default, {
        fontSize: 'small',
      })),
    clearOnBlur = !props.freeSolo,
    clearOnEscape = false,
    ...
    popupIcon = _ArrowDropDownIcon ||
      (_ArrowDropDownIcon = (0, import_jsx_runtime3.jsx)(ArrowDropDown_default, {})),
    readOnly = false,
  ...
  const defaultRenderGroup = (params) =>
    (0, import_jsx_runtime3.jsxs)(
      ...
      {
        children: [
          (0, import_jsx_runtime3.jsx)(AutocompleteGroupLabel, {
  ...
  return (0, import_jsx_runtime3.jsxs)(React4.Fragment, {
    children: [
      (0, import_jsx_runtime3.jsx)(AutocompleteRoot, {
        ref,
        className: clsx_default(classes.root, className),
        ownerState,
        ...getRootProps(other),
          ...
          InputProps: {
            ...
            ...((hasClearIcon || hasPopupIcon) && {
              endAdornment: (0, import_jsx_runtime3.jsxs)(AutocompleteEndAdornment, {
                ...
                children: [
                  hasClearIcon
                    ? (0, import_jsx_runtime3.jsx)(AutocompleteClearIndicator, {
                        ...getClearProps(),
                    ...
                    : null,
                  hasPopupIcon
                    ? (0, import_jsx_runtime3.jsx)(AutocompletePopupIndicator, {
                        ...getPopupIndicatorProps(),
                        disabled,
      ...
      anchorEl
        ? (0, import_jsx_runtime3.jsx)(AutocompletePopper, {
            as: PopperSlot,
            ...popperProps,
            children: (0, import_jsx_runtime3.jsxs)(AutocompletePaper, {
              ...
              children: [
                loading && groupedOptions.length === 0
                  ? (0, import_jsx_runtime3.jsx)(AutocompleteLoading, {
                ...
                groupedOptions.length === 0 && !freeSolo && !loading
                  ? (0, import_jsx_runtime3.jsx)(AutocompleteNoOptions, {
...
true
  ? (Autocomplete.propTypes = {
       ...
       * @default false
       */
      blurOnSelect: import_prop_types2.default.oneOfType([
        import_prop_types2.default.oneOf(['mouse', 'touch']),
       ...
       * @default 'auto'
       */
      forcePopupIcon: import_prop_types2.default.oneOfType([
      ...
      size: import_prop_types2.default.oneOfType([
        import_prop_types2.default.oneOf(['small', 'medium']),
      ...
      slotProps: import_prop_types2.default.shape({
        chip: import_prop_types2.default.oneOfType([
          import_prop_types2.default.func,
          import_prop_types2.default.object,
        ]),
        clearIndicator: import_prop_types2.default.oneOfType([
          import_prop_types2.default.func,
          import_prop_types2.default.object,
        ]),
        listbox: import_prop_types2.default.oneOfType([
          import_prop_types2.default.func,
          import_prop_types2.default.object,
        ]),
        paper: import_prop_types2.default.oneOfType([
          import_prop_types2.default.func,
          import_prop_types2.default.object,
        ]),
        popper: import_prop_types2.default.oneOfType([
          import_prop_types2.default.func,
          import_prop_types2.default.object,
        ]),
        popupIndicator: import_prop_types2.default.oneOfType([
          import_prop_types2.default.func,
          import_prop_types2.default.object,
        ]),
      }),
...
//# sourceMappingURL=chunk-LIH46KFO.js.map
