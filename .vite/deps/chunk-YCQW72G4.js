...
import { useId_default } from './chunk-43F3PPJC.js';
...
var IconButton = React2.forwardRef(function IconButton2(inProps, ref) {
  ...
  const loadingIndicator =
    ...
    (0, import_jsx_runtime2.jsx)(CircularProgress_default, {
...
true
  ? (IconButton.propTypes = {
      ...
      children: chainPropTypes(import_prop_types2.default.node, (props) => {
        const found = React2.Children.toArray(props.children).some(
          (child) => React2.isValidElement(child) && child.props.onClick
        );
        if (found) {
          return new Error(
            [
      ...
      size: import_prop_types2.default.oneOfType([
        import_prop_types2.default.oneOf(['small', 'medium', 'large']),
        import_prop_types2.default.string,
      ]),
      /**
       * The system prop that allows defining system overrides as well as additional CSS styles.
...
//# sourceMappingURL=chunk-YCQW72G4.js.map
