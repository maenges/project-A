...
import { FormHelperText_default } from './chunk-BB4CMEPS.js';
import { useSlot } from './chunk-A4JXHZ37.js';
import { FormControl_default } from './chunk-V34VPTFJ.js';
import { InputLabel_default } from './chunk-5SB3Z3ER.js';
...
var TextField = React.forwardRef(function TextField2(inProps, ref) {
  ...
  return (0, import_jsx_runtime.jsxs)(RootSlot, {
    ...
    children: [
      label != null &&
        label !== '' &&
        (0, import_jsx_runtime.jsx)(InputLabelSlot, {
          htmlFor: id,
          id: inputLabelId,
          ...inputLabelProps,
          children: label,
      ...
      select
        ? (0, import_jsx_runtime.jsx)(SelectSlot, {
            'aria-describedby': helperTextId,
            id,
        ...
        : InputElement,
      helperText &&
        (0, import_jsx_runtime.jsx)(FormHelperTextSlot, {
          id: helperTextId,
          ...formHelperTextProps,
          children: helperText,
        }),
...
true
  ? (TextField.propTypes = {
       ...
       */
      maxRows: import_prop_types.default.oneOfType([
       ...
       */
      minRows: import_prop_types.default.oneOfType([
        import_prop_types.default.number,
        import_prop_types.default.string,
      ]),
      /**
       ...
       */
      rows: import_prop_types.default.oneOfType([
        import_prop_types.default.number,
        import_prop_types.default.string,
      ]),
      /**
      ...
      size: import_prop_types.default.oneOfType([
        import_prop_types.default.oneOf(['medium', 'small']),
        import_prop_types.default.string,
      ]),
      /**
      ...
      slotProps: import_prop_types.default.shape({
        formHelperText: import_prop_types.default.oneOfType([
          import_prop_types.default.func,
          import_prop_types.default.object,
        ]),
        htmlInput: import_prop_types.default.oneOfType([
          import_prop_types.default.func,
          import_prop_types.default.object,
        ]),
        input: import_prop_types.default.oneOfType([
          import_prop_types.default.func,
          import_prop_types.default.object,
        ]),
        inputLabel: import_prop_types.default.oneOfType([
          import_prop_types.default.func,
          import_prop_types.default.object,
        ]),
        select: import_prop_types.default.oneOfType([
          import_prop_types.default.func,
          import_prop_types.default.object,
        ]),
      }),
...
export { getTextFieldUtilityClass, textFieldClasses_default, TextField_default };
//# sourceMappingURL=chunk-276ALPPC.js.map
