...
var SvgIconRoot = styled_default('svg', {
  ...
  memoTheme_default(({ theme }) => {
    ...
    return {
      ...
      flexShrink: 0,
      transition:
        (_d = (_a = theme.transitions) == null ? void 0 : _a.create) == null
          ? void 0
          : _d.call(_a, 'fill', {
              duration:
                (_c = (_b = (theme.vars ?? theme).transitions) == null ? void 0 : _b.duration) ==
                null
                  ? void 0
                  : _c.shorter,
            }),
      variants: [
        ...
        },
        {
          ...
          style: {
            fontSize:
              ((_f = (_e = theme.typography) == null ? void 0 : _e.pxToRem) == null
                ? void 0
                : _f.call(_e, 20)) || '1.25rem',
          },
        },
        {
          props: {
          ...
          style: {
            fontSize:
              ((_h = (_g = theme.typography) == null ? void 0 : _g.pxToRem) == null
                ? void 0
                : _h.call(_g, 24)) || '1.5rem',
          },
        },
        {
          props: {
          ...
          style: {
            fontSize:
              ((_j = (_i = theme.typography) == null ? void 0 : _i.pxToRem) == null
                ? void 0
                : _j.call(_i, 35)) || '2.1875rem',
          },
        },
        ...
        ...Object.entries((theme.vars ?? theme).palette)
          ...
          .map(([color]) => {
            ...
            return {
              ...
              style: {
                color:
                  (_b2 = (_a2 = (theme.vars ?? theme).palette) == null ? void 0 : _a2[color]) ==
                  null
                    ? void 0
                    : _b2.main,
              },
          ...
          }),
        {
          ...
          style: {
            color:
              (_l = (_k = (theme.vars ?? theme).palette) == null ? void 0 : _k.action) == null
                ? void 0
                : _l.active,
          },
        },
        {
          ...
          style: {
            color:
              (_n = (_m = (theme.vars ?? theme).palette) == null ? void 0 : _m.action) == null
                ? void 0
                : _n.disabled,
          },
        },
...
true
  ? (SvgIcon.propTypes = {
      ...
      fontSize: import_prop_types.default.oneOfType([
        import_prop_types.default.oneOf(['inherit', 'large', 'medium', 'small']),
        import_prop_types.default.string,
      ]),
      /**
...
//# sourceMappingURL=chunk-TLMSET2H.js.map
