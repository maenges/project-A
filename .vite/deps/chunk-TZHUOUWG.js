...
(function (_jsx15) {
  var JSX;
  /* @__PURE__ */ (function (_JSX) {})(JSX || (JSX = _jsx15.JSX || (_jsx15.JSX = {})));
})(jsx || (jsx = {}));
...
function GlobalStyles(props) {
  ...
  const globalStyles =
    typeof styles === 'function'
      ? (themeInput) => styles(isEmpty(themeInput) ? defaultTheme4 : themeInput)
      : styles;
...
function deepClone(source) {
  if (
    React7.isValidElement(source) ||
    (0, import_react_is.isValidElementType)(source) ||
...
function deepmerge(
  ...
  if (isPlainObject(target) && isPlainObject(source)) {
    Object.keys(source).forEach((key) => {
      if (
        React7.isValidElement(source[key]) ||
        (0, import_react_is.isValidElementType)(source[key])
      ) {
...
function sortContainerQueries(theme, css2) {
  ...
  const sorted = Object.keys(css2)
    .filter((key) => key.startsWith('@container'))
    .sort((a, b) => {
      var _a, _b;
      const regex = /min-width:\s*([0-9.]+)/;
      return (
        +(((_a = a.match(regex)) == null ? void 0 : _a[1]) || 0) -
        +(((_b = b.match(regex)) == null ? void 0 : _b[1]) || 0)
      );
    });
  if (!sorted.length) {
    return css2;
...
For example, \`@sm\` or \`@600\` or \`@40rem/sidebar\`.`
          : formatMuiErrorMessage(18, `(${shorthand})`)
      );
    }
    return null;
  }
...
var maxWidth = (props) => {
  if (props.maxWidth !== void 0 && props.maxWidth !== null) {
    const styleFromPropValue = (propValue) => {
      ...
      const breakpoint =
        ((_c =
          (_b = (_a = props.theme) == null ? void 0 : _a.breakpoints) == null
            ? void 0
            : _b.values) == null
          ? void 0
          : _c[propValue]) || values[propValue];
      if (!breakpoint) {
        return {
      ...
      if (
        ((_e = (_d = props.theme) == null ? void 0 : _d.breakpoints) == null ? void 0 : _e.unit) !==
        'px'
      ) {
        return {
...
function applyStyles(key, styles) {
  ...
  if (theme.vars) {
    if (
      !((_a = theme.colorSchemes) == null ? void 0 : _a[key]) ||
...
var splitProps = (props) => {
  ...
  const config =
    ((_a = props == null ? void 0 : props.theme) == null ? void 0 : _a.unstable_sxConfig) ??
    defaultSxConfig_default;
...
function shallowLayer(serialized, layerName) {
  if (
    ...
    serialized.styles &&
    !serialized.styles.startsWith('@layer')
  ) {
...
function processStyle(props, style4, layerName) {
  ...
  if (Array.isArray(resolvedStyle == null ? void 0 : resolvedStyle.variants)) {
    ...
    if (resolvedStyle.isProcessed) {
      ...
      rootStyle = layerName
        ? shallowLayer(internal_serializeStyles(otherStyles), layerName)
        : otherStyles;
    }
  ...
  if (resolvedStyle == null ? void 0 : resolvedStyle.isProcessed) {
    return layerName
      ? shallowLayer(internal_serializeStyles(resolvedStyle.style), layerName)
      : resolvedStyle.style;
  }
  return layerName
    ? shallowLayer(internal_serializeStyles(resolvedStyle), layerName)
    : resolvedStyle;
}
function processStyleVariants(props, variants, results = [], layerName = void 0) {
  ...
  variantLoop: for (let i = 0; i < variants.length; i += 1) {
    ...
    if (typeof variant.props === 'function') {
      ...
      for (const key in variant.props) {
        if (
          ...
          ((_a = props.ownerState) == null ? void 0 : _a[key]) !== variant.props[key]
        ) {
    ...
    if (typeof variant.style === 'function') {
      ...
      results.push(
        layerName
          ? shallowLayer(internal_serializeStyles(variant.style(mergedState)), layerName)
          : variant.style(mergedState)
      );
    } else {
      results.push(
        layerName ? shallowLayer(internal_serializeStyles(variant.style), layerName) : variant.style
      );
    }
  }
  return results;
...
function createStyled3(input = {}) {
  ...
  const styled4 = (tag, inputOptions = {}) => {
    internal_mutateStyles(tag, (styles) =>
      styles.filter((style4) => style4 !== styleFunctionSx_default)
    );
    const {
      name: componentName,
      slot: componentSlot,
    ...
    const muiStyledResolver = (...expressionsInput) => {
      ...
      if (componentName && overridesResolver) {
        expressionsTail.push(function styleThemeOverrides(props) {
          ...
          const styleOverrides =
            (_b = (_a = theme.components) == null ? void 0 : _a[componentName]) == null
              ? void 0
              : _b.styleOverrides;
          if (!styleOverrides) {
            return null;
          ...
          for (const slotKey in styleOverrides) {
            resolvedStyleOverrides[slotKey] = processStyle(
              ...
              props.theme.modularCssLayers ? 'theme' : void 0
            );
          }
      ...
      if (componentName && !skipVariantsResolver) {
        expressionsTail.push(function styleThemeVariants(props) {
          ...
          const themeVariants =
            (_b =
              (_a = theme == null ? void 0 : theme.components) == null
                ? void 0
                : _a[componentName]) == null
              ? void 0
              : _b.variants;
          if (!themeVariants) {
            return null;
...
function unstable_createUseMediaQuery(params = {}) {
  ...
  return function useMediaQuery2(queryInput, options = {}) {
    ...
    const match2 = useMediaQueryImplementation(
      query,
      defaultMatches,
      matchMedia,
      ssrMatchMedia,
...
function hexToRgb(color2) {
  ...
  if (true) {
    if (color2.length !== color2.trim().length) {
      console.error(
        `MUI: The color: "${color2}" is invalid. Make sure the color input doesn't contain leading/trailing space.`
      );
    }
  }
  return colors
...
var elementTypeAcceptingRef_default = chainPropTypes(
  import_prop_types8.default.elementType,
...
var refType = import_prop_types9.default.oneOfType([
...
function isMuiElement(element, muiNames) {
  var _a, _b, _c;
  return (
    React13.isValidElement(element) &&
    muiNames.indexOf(
      // For server components `muiName` is avaialble in element.type._payload.value.muiName
      // relevant info - https://github.com/facebook/react/blob/2807d781a08db8e9873687fccc25c0f12b4fb3d4/packages/react/src/ReactLazy.js#L45
      // eslint-disable-next-line no-underscore-dangle
      element.type.muiName ??
        ((_c =
          (_b = (_a = element.type) == null ? void 0 : _a._payload) == null ? void 0 : _b.value) ==
        null
          ? void 0
          : _c.muiName)
    ) !== -1
...
function useControlled({ controlled, default: defaultProp, name, state = 'value' }) {
  const { current: isControlled } = React15.useRef(controlled !== void 0);
  ...
  if (true) {
    ...
    const { current: defaultValue } = React15.useRef(defaultProp);
    React15.useEffect(() => {
...
function useLayerOrder(theme) {
  ...
  useEnhancedEffect_default(() => {
    ...
    if (layerOrder) {
      if (
        firstChild &&
        ((_a = firstChild.hasAttribute) == null
          ? void 0
          : _a.call(firstChild, 'data-mui-layer-order')) &&
      ...
      (_b = head.querySelector(`style[data-mui-layer-order="${id}"]`)) == null
        ? void 0
        : _b.remove();
    }
  }, [layerOrder, id]);
...
true
  ? (ThemeProvider3.propTypes = {
       ...
       * A theme object. You can provide a function to extend the outer theme.
       */
      theme: import_prop_types13.default.oneOfType([
...
function useCurrentColorScheme(options) {
  ...
  const modeStorage = React33.useMemo(
    () =>
      storageManager == null
        ? void 0
        : storageManager({
  ...
  const lightStorage = React33.useMemo(
    () =>
      storageManager == null
        ? void 0
        : storageManager({
  ...
  const darkStorage = React33.useMemo(
    () =>
      storageManager == null
        ? void 0
        : storageManager({
  ...
  const [state, setState] = React33.useState(() => {
    const initialMode =
      (modeStorage == null ? void 0 : modeStorage.get(defaultMode)) || defaultMode;
    const lightColorScheme =
      (lightStorage == null ? void 0 : lightStorage.get(defaultLightColorScheme)) ||
      defaultLightColorScheme;
    const darkColorScheme =
      (darkStorage == null ? void 0 : darkStorage.get(defaultDarkColorScheme)) ||
      defaultDarkColorScheme;
    return {
      mode: initialMode,
  ...
  const setMode = React33.useCallback(
    (mode) => {
  ...
  const setColorScheme = React33.useCallback(
    (value) => {
      if (!value) {
        setState((currentState) => {
  ...
  const handleMediaQuery = React33.useCallback(
    (event) => {
...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider(props) {
    ...
    const joinedColorSchemes = Object.keys(colorSchemes)
      ...
      .join(',');
    const allColorSchemes = React34.useMemo(
    ...
    const defaultMode =
      colorSchemes[defaultLightColorScheme2] && colorSchemes[defaultDarkColorScheme2]
        ? initialMode
        : ((_b =
            (_a = colorSchemes[restThemeProp.defaultColorScheme]) == null ? void 0 : _a.palette) ==
          null
            ? void 0
            : _b.mode) || ((_c = restThemeProp.palette) == null ? void 0 : _c.mode);
    const {
      mode: stateMode,
      setMode,
      systemMode,
    ...
    const memoTheme = React34.useMemo(() => {
      ...
      const themeVars =
        ((_a2 = restThemeProp.generateThemeVars) == null ? void 0 : _a2.call(restThemeProp)) ||
        restThemeProp.vars;
      const theme = {
        ...restThemeProp,
        components,
    ...
    useEnhancedEffect_default(() => {
      if (
        ...
        if (
          (selector == null ? void 0 : selector.startsWith('data-')) &&
          !selector.includes('%s')
        ) {
          rule = `[${selector}="%s"]`;
        }
      ...
      children: [
        ...
        shouldGenerateStyleSheet &&
          (0, import_jsx_runtime11.jsx)(GlobalStyles, {
            styles:
              ((_d = memoTheme.generateStyleSheets) == null ? void 0 : _d.call(memoTheme)) || [],
          }),
      ],
    });
    if (nested) {
...
function prepareCssVars(theme, parserConfig = {}) {
  ...
  Object.entries(otherColorSchemes || {}).forEach(([key, scheme]) => {
    const { vars, css: css2, varsWithDefaults } = cssVarsParser(scheme, parserConfig);
  ...
  if (defaultScheme) {
    const { css: css2, vars, varsWithDefaults } = cssVarsParser(defaultScheme, parserConfig);
    themeVars = deepmerge(themeVars, varsWithDefaults);
  ...
  function defaultGetSelector(colorScheme, cssObject) {
    ...
    if (colorScheme) {
      if (rule === 'media') {
        ...
        const mode =
          ((_b = (_a = colorSchemes[colorScheme]) == null ? void 0 : _a.palette) == null
            ? void 0
            : _b.mode) || colorScheme;
        return {
  ...
  const generateStyleSheets = () => {
    ...
    if (defaultSchemeVal) {
      const { css: css2 } = defaultSchemeVal;
      const cssColorSheme =
        (_b = (_a = colorSchemes[colorScheme]) == null ? void 0 : _a.palette) == null
          ? void 0
          : _b.mode;
    ...
    Object.entries(other).forEach(([key, { css: css2 }]) => {
      var _a2, _b2;
      const cssColorSheme =
        (_b2 = (_a2 = colorSchemes[key]) == null ? void 0 : _a2.palette) == null
          ? void 0
          : _b2.mode;
      const finalCss =
        !disableCssColorScheme && cssColorSheme
...
function createContainer(options = {}) {
  ...
  true
    ? (Container2.propTypes = {
        ...
        maxWidth: import_prop_types15.default.oneOfType([
          import_prop_types15.default.oneOf(['xs', 'sm', 'md', 'lg', 'xl', false]),
...
true
  ? (Container.propTypes = {
       ...
       * @default 'lg'
       */
      maxWidth: import_prop_types16.default.oneOfType([
        import_prop_types16.default.oneOf(['xs', 'sm', 'md', 'lg', 'xl', false]),
...
function createGrid(options = {}) {
  ...
  const useUtilityClasses2 = (ownerState, theme) => {
    const { container, direction, spacing: spacing2, wrap, size } = ownerState;
    const slots = {
      root: [
        'root',
        container && 'container',
        ...
        ...(container ? generateSpacingClassNames(spacing2, theme.breakpoints.keys[0]) : []),
      ],
    };
  ...
  const Grid2 = React36.forwardRef(function Grid3(inProps, ref) {
    ...
    const columnSpacing =
      inProps.columnSpacing ?? inProps.spacing ?? (level ? void 0 : columnSpacingProp);
    const ownerState = {
      ...props,
      level,
      columns,
  ...
  true
    ? (Grid2.propTypes = {
        ...
        columns: import_prop_types17.default.oneOfType([
          import_prop_types17.default.arrayOf(import_prop_types17.default.number),
          import_prop_types17.default.number,
          import_prop_types17.default.object,
        ]),
        columnSpacing: import_prop_types17.default.oneOfType([
        ...
        direction: import_prop_types17.default.oneOfType([
          import_prop_types17.default.oneOf(['column-reverse', 'column', 'row-reverse', 'row']),
          import_prop_types17.default.arrayOf(
            import_prop_types17.default.oneOf(['column-reverse', 'column', 'row-reverse', 'row'])
          ),
          import_prop_types17.default.object,
        ]),
        offset: import_prop_types17.default.oneOfType([
          import_prop_types17.default.string,
          import_prop_types17.default.number,
          import_prop_types17.default.arrayOf(
            import_prop_types17.default.oneOfType([
        ...
        rowSpacing: import_prop_types17.default.oneOfType([
          import_prop_types17.default.arrayOf(
            import_prop_types17.default.oneOfType([
              import_prop_types17.default.number,
              import_prop_types17.default.string,
...
true
  ? (Grid.propTypes = {
       ...
       * @default 12
       */
      columns: import_prop_types18.default.oneOfType([
       ...
       */
      columnSpacing: import_prop_types18.default.oneOfType([
      ...
      direction: import_prop_types18.default.oneOfType([
        import_prop_types18.default.oneOf(['column-reverse', 'column', 'row-reverse', 'row']),
        import_prop_types18.default.arrayOf(
          import_prop_types18.default.oneOf(['column-reverse', 'column', 'row-reverse', 'row'])
        ),
        import_prop_types18.default.object,
       ...
       */
      offset: import_prop_types18.default.oneOfType([
        import_prop_types18.default.string,
        import_prop_types18.default.number,
        import_prop_types18.default.arrayOf(
          import_prop_types18.default.oneOfType([
       ...
       * It overrides the value of the `spacing` prop.
       */
      rowSpacing: import_prop_types18.default.oneOfType([
        import_prop_types18.default.arrayOf(
          import_prop_types18.default.oneOfType([
            import_prop_types18.default.number,
            import_prop_types18.default.string,
...
function joinChildren(children, separator) {
  ...
  return childrenArray.reduce((output, child, index) => {
    ...
    if (index < childrenArray.length - 1) {
      output.push(
        React37.cloneElement(separator, {
          key: `separator-${index}`,
        })
      );
    }
...
function createStack(options = {}) {
  ...
  true
    ? (Stack2.propTypes = {
        ...
        direction: import_prop_types19.default.oneOfType([
          import_prop_types19.default.oneOf(['column-reverse', 'column', 'row-reverse', 'row']),
        ...
        spacing: import_prop_types19.default.oneOfType([
          import_prop_types19.default.arrayOf(
...
true
  ? (Stack.propTypes = {
       ...
       * @default 'column'
       */
      direction: import_prop_types20.default.oneOfType([
        import_prop_types20.default.oneOf(['column-reverse', 'column', 'row-reverse', 'row']),
       ...
       * @default 0
       */
      spacing: import_prop_types20.default.oneOfType([
        import_prop_types20.default.arrayOf(
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-TZHUOUWG.js.map
