...
import { require_hoist_non_react_statics_cjs } from './chunk-4LSKKDHM.js';
  ...
  'node_modules/szfe-tools/lib/flatten.js'(exports) {
    ...
    var flatten = function flatten2(array) {
      return array.reduce(function (res, item) {
        return [].concat(
          (0, _toConsumableArray2.default)(res),
          (0, _toConsumableArray2.default)((0, _isArray.default)(item) ? flatten2(item) : [item])
        );
      }, []);
    };
  ...
  'node_modules/szfe-tools/lib/get.js'(exports) {
    ...
    function get(obj) {
      ...
      try {
        ...
        var result = ((0, _isString.default)(keys) ? keys.split('.') : keys).reduce(function (
          res,
          key
        ) {
          return res[key];
...
// node_modules/szfe-tools/lib/random.js
var require_random = __commonJS({
  'node_modules/szfe-tools/lib/random.js'(exports) {
    'use strict';
    Object.defineProperty(exports, '__esModule', {
      value: true,
    });
    ...
    var random = function random2(min, max) {
      var int = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true;
  ...
  'node_modules/szfe-tools/lib/isObject.js'(exports) {
    ...
    var isObject = function isObject2(value) {
      return (
        ...
        !((0, _isArray.default)(value) || (0, _isNull.default)(value))
      );
    };
  ...
  'node_modules/szfe-tools/lib/value.js'(exports) {
    ...
    var value = function value2() {
      ...
      return values.reduce(
        function (value3, nextValue) {
          return (0, _isUndefined.default)(value3)
            ? (0, _run.default)(nextValue)
            : (0, _run.default)(value3);
        },
        void 0
      );
    };
...
var require_globalThis = __commonJS({
  'node_modules/szfe-tools/lib/globalThis.js'(exports) {
    ...
    var getGlobal = function getGlobal2() {
      if (
        // @ts-ignore
        (typeof global === 'undefined' ? 'undefined' : (0, _typeof2.default)(global)) !==
          'object' || // @ts-ignore
        !global || // @ts-ignore
...
var require_lib = __commonJS({
  'node_modules/react-node-key/lib/index.js'(exports) {
    ...
    var genRenderPath = function genRenderPath2(node) {
      return node['return']
        ? [node].concat(_toConsumableArray(genRenderPath2(node['return'])))
        : [node];
    };
      ...
      _createClass(NodeKey2, [
        {
          ...
          value: function render() {
            ...
            return _run(
              children,
              void 0,
              ''.concat(prefix).concat(this.key || this.genKey(onHandleNode))
            );
          },
        },
      ]);
...
var require_lib2 = __commonJS({
  'node_modules/react-activation/lib/index.js'(exports) {
    ...
    var _isFunction = _interopDefault(require_isFunction());
    var _random = _interopDefault(require_random());
    ...
    function createReactContext(defaultValue, calculateChangedBits) {
      ...
      var Consumer = (function (_Component2) {
        function Consumer2() {
          ...
          _this2 = _callSuper(this, Consumer2, [].concat(args));
        ...
        return _createClass(Consumer2, [
          {
            key: 'componentWillReceiveProps',
            value: function componentWillReceiveProps(nextProps) {
              var observedBits = nextProps.observedBits;
              this.observedBits =
                observedBits === void 0 || observedBits === null
                  ? MAX_SIGNED_31_BIT_INT
                  : observedBits;
            },
          },
      ...
      return _createClass(FakeScopeProvider2, [
        {
          ...
          value: function shouldComponentUpdate(nextProps) {
            ...
            return (
              nextProps.children !== this.props.children || nextProps.value !== this.props.value
            );
          },
        },
        {
    ...
    var FakeScopeConsumer = (function (_PureComponent) {
      function FakeScopeConsumer2(props) {
        ...
        _this2 = _callSuper(this, FakeScopeConsumer2, [props]);
        _defineProperty(_this2, 'state', {
        ...
        _defineProperty(
          _this2,
          'updateListener',
          _debounce(function (nextContextValue) {
            _this2.setState({
      ...
      return _createClass(FakeScopeConsumer2, [
        {
          key: 'componentWillUnmount',
          value: function componentWillUnmount() {
    ...
    var AliveScopeConsumer$1 = function AliveScopeConsumer$12(_ref2) {
      ...
      return React__default.createElement(
        ...
        function (reactContext) {
          return !!reactContext
            ? _run(children, void 0, reactContext)
            : React__default.createElement(
                FakeScopeConsumer,
                {
    ...
    var Suspender = (function (_Component) {
      function Suspender2() {
        ...
        _this = _callSuper(this, Suspender2, [].concat(args));
        _defineProperty(_this, 'promiseCache', {});
        return _this;
      }
      _inherits(Suspender2, _Component);
      return _createClass(Suspender2, [
        {
          key: 'render',
          value: function render() {
            var _this$props = this.props,
    ...
    var autoFixContext = function autoFixContext2() {
      try {
        for (
          var _len2 = arguments.length, configs = new Array(_len2), _key2 = 0;
          _key2 < _len2;
          _key2++
        ) {
    ...
    var ProviderBridge = (function (_PureComponent) {
      function ProviderBridge2(props) {
        ...
        _this = _callSuper(this, ProviderBridge2, [props]);
      ...
      return _createClass(ProviderBridge2, [
        {
          key: 'componentWillUnmount',
          value: function componentWillUnmount() {
            _run(this.unmount);
        ...
        },
        {
          ...
          value: function render() {
            ...
            var nextChildren = !_isUndefined(ctxValue)
              ? React__default.createElement(
                  Provider,
                  {
                    value: ctxValue,
    ...
    var ConsumerWrapper = (function (_Component) {
      function ConsumerWrapper2(props) {
        ...
        _this = _callSuper(this, ConsumerWrapper2, [props]);
      ...
      return _createClass(ConsumerWrapper2, [
        {
          key: 'componentWillUnmount',
          value: function componentWillUnmount() {
            var _this$props = this.props,
            ...
            updateListenerCache.set(
              ctx,
              _objectSpread2(
                _objectSpread2({}, _get(updateListenerCache.get(ctx), void 0, {})),
                {},
                _defineProperty({}, id, this.updateListener)
              )
            );
          },
          ...
          value: function render() {
            ...
            return renderWrapper(function (ctx$$) {
              return renderContent(
                _isUndefined(value) ? ctx$$ : [].concat(_toConsumableArray(ctx$$), [_this2.ctxInfo])
              );
            });
          },
        },
    ...
    var RecursiveConsumerBridge = (function (_PureComponent) {
      function RecursiveConsumerBridge2(props) {
        ...
        _this = _callSuper(this, RecursiveConsumerBridge2, [props]);
        _defineProperty(_this, 'renderWrapper', function (renderChildren) {
          var id = _this.props.id;
          var renderWrapper = fixedContextSnapshot[id].reduce(
            function (render, ctx) {
      ...
      return _createClass(RecursiveConsumerBridge2, [
        {
          key: 'render',
          value: function render() {
    ...
    var FallbackListener = (function (_Component) {
      function FallbackListener2() {
        ...
        return _callSuper(this, FallbackListener2, arguments);
      }
      _inherits(FallbackListener2, _Component);
      return _createClass(FallbackListener2, [
        {
          key: 'componentDidMount',
          value: function componentDidMount() {
    ...
    var LazyBridge = isSupported
      ? (function (_Component2) {
          function LazyBridge2() {
            ...
            _this = _callSuper(this, LazyBridge2, [].concat(args));
          ...
          return _createClass(LazyBridge2, [
            {
              key: 'render',
              value: function render() {
                var children = this.props.children;
                return React__default.createElement(
                  React.Fragment,
                  null,
                  _run(children, void 0, this.sus$$),
                  this.state.suspense &&
                    React__default.createElement(Lazy, {
    ...
    var ErrorBoundaryBridge = (function (_Component) {
      function ErrorBoundaryBridge2() {
        ...
        return _callSuper(this, ErrorBoundaryBridge2, arguments);
      }
      _inherits(ErrorBoundaryBridge2, _Component);
      return _createClass(ErrorBoundaryBridge2, [
        {
    ...
    var ErrorThrower = (function (_Component2) {
      function ErrorThrower2() {
        ...
        _this = _callSuper(this, ErrorThrower2, [].concat(args));
        _defineProperty(_this, 'state', {
          error: null,
        });
      ...
      return _createClass(ErrorThrower2, [
        {
          key: 'render',
          value: function render() {
            if (this.state.error) {
    ...
    var withActivation = function withActivation2(WrappedComponent) {
      var HOC = (function (_Component) {
        function HOC2() {
          ...
          _this = _callSuper(this, HOC2, [].concat(args));
          _defineProperty(_this, 'drop', null);
          return _this;
        }
        _inherits(HOC2, _Component);
        return _createClass(HOC2, [
          {
            key: 'componentWillUnmount',
            value: function componentWillUnmount() {
              _run(this.drop);
    ...
    var useActivation = function useActivation2(funcName, func) {
      if (
        [React.useRef, React.useContext, React.useEffect].some(function (fn) {
    ...
    var Keeper = (function (_PureComponent) {
      function Keeper2(props) {
        ...
        _this = _callSuper(this, Keeper2, [props].concat(rest));
        _defineProperty(_this, 'eventBus', new _EventBus());
        _defineProperty(_this, 'listeners', /* @__PURE__ */ new Map());
        ...
        _defineProperty(_this, 'attach', function (ref) {
          ...
          if (ref.isKeepAlive) {
            _nextTick(function () {
              ...
              cache.aliveNodesId = new Set(
                [].concat(_toConsumableArray(cache.aliveNodesId), [ref.id])
              );
            });
          }
          listeners.set(
            ref,
            _defineProperty(
              _defineProperty({}, LIFECYCLE_ACTIVATE, function () {
    ...
    var AliveScope = (function (_Component) {
      function AliveScope2() {
        ...
        _this = _callSuper(this, AliveScope2, [].concat(args));
        _defineProperty(_this, 'store', /* @__PURE__ */ new Map());
        _defineProperty(_this, 'nodes', /* @__PURE__ */ new Map());
        _defineProperty(_this, 'keepers', /* @__PURE__ */ new Map());
        _defineProperty(
          _this,
        ...
        _defineProperty(_this, 'dropScopeByIds', function (ids) {
          ...
          return (_this3 = _this).handleNodes.apply(
            _this3,
            [_this.getScopeIds(ids), HANDLE_TYPE_DROP].concat(rest)
          );
        });
        _defineProperty(_this, 'drop', function (name) {
          ...
          return (_this4 = _this).handleNodes.apply(
            _this4,
            [
              _this.getCachingNodesByName(name).map(function (node) {
                return node.id;
              }),
              HANDLE_TYPE_DROP,
            ].concat(rest)
        ...
        _defineProperty(_this, 'dropScope', function (name) {
          ...
          return (_this5 = _this).dropScopeByIds.apply(
            _this5,
            [
              _this.getCachingNodesByName(name).map(function (_ref) {
                var id = _ref.id;
                return id;
              }),
            ].concat(rest)
        ...
        _defineProperty(_this, 'refreshById', function (id) {
          ...
          return (_this6 = _this).handleNodes.apply(
            _this6,
            [[id], HANDLE_TYPE_REFRESH].concat(rest)
          );
        });
        _defineProperty(_this, 'refreshScopeByIds', function (ids) {
          ...
          return (_this7 = _this).handleNodes.apply(
            _this7,
            [_this.getScopeIds(ids), HANDLE_TYPE_REFRESH].concat(rest)
          );
        });
        _defineProperty(_this, 'refresh', function (name) {
          var _this8;
          for (
            var _len8 = arguments.length, rest = new Array(_len8 > 1 ? _len8 - 1 : 0), _key8 = 1;
            _key8 < _len8;
            _key8++
          ) {
            rest[_key8 - 1] = arguments[_key8];
          }
          return (_this8 = _this).handleNodes.apply(
            _this8,
            [
              _this.getCachingNodesByName(name).map(function (node) {
                return node.id;
        ...
        _defineProperty(_this, 'refreshScope', function (name) {
          var _this9;
          for (
            var _len9 = arguments.length, rest = new Array(_len9 > 1 ? _len9 - 1 : 0), _key9 = 1;
            _key9 < _len9;
            _key9++
          ) {
            rest[_key9 - 1] = arguments[_key9];
          }
          return (_this9 = _this).refreshScopeByIds.apply(
            _this9,
            [
              _this.getCachingNodesByName(name).map(function (_ref2) {
                var id = _ref2.id;
                return id;
              }),
            ].concat(rest)
        ...
        _defineProperty(_this, 'handleNodes', function (nodesId) {
          var type =
            arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : HANDLE_TYPE_DROP;
          for (
            var _len0 = arguments.length, rest = new Array(_len0 > 2 ? _len0 - 2 : 0), _key0 = 2;
            _key0 < _len0;
            _key0++
          ) {
          ...
          return new Promise(function (resolve) {
            ...
            Promise.all(
              handleKeepers.map(function (keeper) {
        ...
        _defineProperty(_this, 'clear', function () {
          var _this0;
          for (
            var _len1 = arguments.length, rest = new Array(_len1), _key1 = 0;
            _key1 < _len1;
            _key1++
          ) {
            rest[_key1] = arguments[_key1];
          }
          return (_this0 = _this).handleNodes.apply(
            _this0,
            [
              _this.getCachingNodes().map(function (_ref3) {
                var id = _ref3.id;
                return id;
              }),
              HANDLE_TYPE_DROP,
      ...
      return _createClass(AliveScope2, [
        {
          key: 'render',
          value: function render() {
            var _this1 = this;
    ...
    var _excluded2 = ['id', 'forwardedRef'];
    ...
    var expandKeepAlive = function expandKeepAlive2(KeepAlive2) {
      ...
      if (_isFunction(React.forwardRef)) {
        ...
        return hoistStatics(ForwardedRefHOC, KeepAlive2);
      } else {
        return hoistStatics(ExpandKeepAlive, KeepAlive2);
      }
    };
    ...
    function getScrollableNodes(from) {
      ...
      return []
        .concat(_toConsumableArray(_value(_run(from, 'querySelectorAll', '*'), [])), [from])
        .filter(isScrollableNode);
    }
    function saveScrollPosition(from) {
      var nodes = _toConsumableArray(
        new Set(_toConsumableArray(_flatten(from.map(getScrollableNodes))))
      );
    ...
    var screenScrollingElement = _get(
      _globalThis,
      'document.scrollingElement',
      _get(_globalThis, 'document.documentElement', {})
    );
    ...
    var KeepAlive = (function (_Component) {
      function KeepAlive2(props) {
        ...
        _this = _callSuper(this, KeepAlive2, [props]);
        ...
        _defineProperty(_this, 'inject', function () {
          ...
          var _this$props = _this.props,
            id = _this$props.id,
            saveScrollPosition2 = _this$props.saveScrollPosition,
        ...
        _defineProperty(_this, 'eject', function () {
          ...
          var cache = _helpers.getCache(id);
          var nodesNeedToSaveScrollPosition = _flatten(
            _flatten([_this.props.saveScrollPosition]).map(function (flag) {
              if (flag === true) {
                return cache.nodes;
              }
              if (flag === 'screen') {
              ...
              return _toConsumableArray(
                _value(_run(_globalThis, 'document.querySelectorAll', flag), [])
              );
            })
          ).filter(Boolean);
          try {
      ...
      return _createClass(KeepAlive2, [
        {
          key: 'shouldComponentUpdate',
          value:
        ...
        },
        {
          ...
          value: function componentWillUnmount() {
            ...
            if (!when) {
              if (isScope) {
                var needToDrop = [cache]
                  .concat(
                    _toConsumableArray(
                      _helpers.getScopeIds([id]).map(function (id2) {
    ...
    var KeepAlive$1 = _isFunction(_get(_globalThis, 'document.getElementById'))
