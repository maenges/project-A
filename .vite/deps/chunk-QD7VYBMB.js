...
var require_zoom = __commonJS({
  'node_modules/@react-pdf-viewer/zoom/lib/cjs/zoom.js'(exports) {
    ...
    var createSvgElement = function () {
      return (
        svgElement || (svgElement = document.createElementNS('http://www.w3.org/2000/svg', 'svg'))
      );
    };
      ...
      var renderContent = function (toggle) {
        return React__namespace.createElement(
          ...
          Object.keys(core.SpecialZoomLevel).map(function (k) {
            ...
            return React__namespace.createElement(
              core.MenuItem,
              { key: level, onClick: clickMenuItem },
    ...
    var zoomPlugin = function (props) {
      ...
      var ZoomInDecorator = function (props2) {
        return React__namespace.createElement(
          ZoomIn,
          __assign({ enableShortcuts: zoomPluginProps.enableShortcuts }, props2, { store })
        );
      };
        ...
        var updateSlot = {
          children: React__namespace.createElement(
            ...
            React__namespace.createElement(PinchZoom, {
              pagesContainerRef: props2.pagesContainerRef,
              store,
            }),
            slot.children
          ),
...
export { require_lib2 as require_lib };
...
@react-pdf-viewer/zoom/lib/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-QD7VYBMB.js.map
