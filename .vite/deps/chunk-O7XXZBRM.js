import { Fade_default, List_default } from './chunk-DRP53DCM.js';
...
import { isFilled } from './chunk-AOW7Q6QM.js';
...
import { useEnhancedEffect_default } from './chunk-2MDRTEDQ.js';
import { useControlled_default } from './chunk-43F3PPJC.js';
import { useForkRef_default } from './chunk-VIOYBTRK.js';
import { memoTheme_default } from './chunk-SGNGXQRB.js';
import { capitalize_default } from './chunk-HB5N4A5P.js';
import { useDefaultProps } from './chunk-KVEJKEZ5.js';
import {
    ...
    const contain = () => {
      ...
      if (tabbable.length > 0) {
        const isShiftTab = Boolean(
          ((_a = lastKeydown.current) == null ? void 0 : _a.shiftKey) &&
          ((_b = lastKeydown.current) == null ? void 0 : _b.key) === 'Tab'
        );
...
true
  ? (Backdrop.propTypes = {
      ...
      slotProps: import_prop_types3.default.shape({
        root: import_prop_types3.default.oneOfType([
          import_prop_types3.default.func,
          import_prop_types3.default.object,
        ]),
        transition: import_prop_types3.default.oneOfType([
          import_prop_types3.default.func,
          import_prop_types3.default.object,
        ]),
      }),
       ...
       */
      transitionDuration: import_prop_types3.default.oneOfType([
  ...
  const getTransitionProps = () => {
    ...
    return {
      onEnter: createChainedFunction(
        handleEnter,
        (children == null ? void 0 : children.props.onEnter) ?? noop
      ),
      onExited: createChainedFunction(
        handleExited,
        (children == null ? void 0 : children.props.onExited) ?? noop
      ),
    };
  };
  return {
    ...
    children: (0, import_jsx_runtime4.jsxs)(RootSlot, {
      ...
      children: [
        !hideBackdrop && BackdropComponent
          ? (0, import_jsx_runtime4.jsx)(BackdropSlot, {
              ...backdropProps,
            })
          : null,
        (0, import_jsx_runtime4.jsx)(FocusTrap_default, {
          disableEnforceFocus,
          disableAutoFocus,
          disableRestoreFocus,
...
true
  ? (Modal.propTypes = {
      ...
      componentsProps: import_prop_types4.default.shape({
        ...
        root: import_prop_types4.default.oneOfType([
          import_prop_types4.default.func,
          import_prop_types4.default.object,
        ]),
      }),
       ...
       */
      container: import_prop_types4.default.oneOfType([
        HTMLElementType,
        import_prop_types4.default.func,
      ]),
      /**
...
var Popover = React6.forwardRef(function Popover2(inProps, ref) {
  ...
  const getTransformOrigin = React6.useCallback(
    (elemRect) => {
      return {
  ...
  const getPositioningStyle = React6.useCallback(
    (element) => {
      const elemRect = {
  ...
  const container =
    containerProp || (anchorEl ? ownerDocument_default(resolveAnchorEl(anchorEl)).body : void 0);
...
true
  ? (Popover.propTypes = {
      ...
      anchorEl: chainPropTypes(
        import_prop_types5.default.oneOfType([HTMLElementType, import_prop_types5.default.func]),
        (props) => {
      ...
      anchorOrigin: import_prop_types5.default.shape({
        horizontal: import_prop_types5.default.oneOfType([
          import_prop_types5.default.oneOf(['center', 'left', 'right']),
          import_prop_types5.default.number,
        ]).isRequired,
        vertical: import_prop_types5.default.oneOfType([
          import_prop_types5.default.oneOf(['bottom', 'center', 'top']),
          import_prop_types5.default.number,
        ]).isRequired,
      }),
      /**
      ...
      slotProps: import_prop_types5.default.shape({
        ...
        paper: import_prop_types5.default.oneOfType([
          import_prop_types5.default.func,
          import_prop_types5.default.object,
        ]),
        ...
        transition: import_prop_types5.default.oneOfType([
          import_prop_types5.default.func,
          import_prop_types5.default.object,
        ]),
      }),
      ...
      transitionDuration: import_prop_types5.default.oneOfType([
        import_prop_types5.default.oneOf(['auto']),
        import_prop_types5.default.number,
    ...
    slotProps: {
      ...
      transition: {
        ...
        onEntering: (...args) => {
          var _a;
          handleEntering(...args);
          (_a = resolvedTransitionProps == null ? void 0 : resolvedTransitionProps.onEntering) ==
          null
            ? void 0
            : _a.call(resolvedTransitionProps, ...args);
        },
      },
    },
    open,
...
true
  ? (Menu.propTypes = {
       ...
       */
      anchorEl: import_prop_types6.default.oneOfType([
        HTMLElementType,
      ...
      slotProps: import_prop_types6.default.shape({
        ...
        list: import_prop_types6.default.oneOfType([
          import_prop_types6.default.func,
          import_prop_types6.default.object,
        ]),
        paper: import_prop_types6.default.oneOfType([
          import_prop_types6.default.func,
          import_prop_types6.default.object,
        ]),
        ...
        transition: import_prop_types6.default.oneOfType([
          import_prop_types6.default.func,
          import_prop_types6.default.object,
        ]),
      }),
      ...
      slots: import_prop_types6.default.shape({
        ...
        list: import_prop_types6.default.elementType,
      ...
      transitionDuration: import_prop_types6.default.oneOfType([
        import_prop_types6.default.oneOf(['auto']),
...
var NativeSelectInput = React8.forwardRef(function NativeSelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime7.jsxs)(React8.Fragment, {
    children: [
      (0, import_jsx_runtime7.jsx)(NativeSelectSelect, {
        ownerState,
      ...
      props.multiple
        ? null
        : (0, import_jsx_runtime7.jsx)(NativeSelectIcon, {
            as: IconComponent,
            ownerState,
...
var SelectInput = React9.forwardRef(function SelectInput2(props, ref) {
  ...
  const { current: isOpenControlled } = React9.useRef(openProp != null);
  ...
  return (0, import_jsx_runtime8.jsxs)(React9.Fragment, {
    children: [
      (0, import_jsx_runtime8.jsx)(SelectSelect, {
        as: 'div',
        ...
        children: isEmpty(display)
          ? // notranslate needed while Google Translate will not fix zero-width space issue
            _span ||
            (_span = (0, import_jsx_runtime8.jsx)('span', {
...
true
  ? (SelectInput.propTypes = {
       ...
       * @ignore
       */
      tabIndex: import_prop_types8.default.oneOfType([
...
true
  ? (Input.propTypes = {
      ...
      color: import_prop_types9.default.oneOfType([
        import_prop_types9.default.oneOf(['primary', 'secondary']),
       ...
       */
      rows: import_prop_types9.default.oneOfType([
        import_prop_types9.default.number,
        import_prop_types9.default.string,
      ]),
      /**
...
true
  ? (FilledInput.propTypes = {
       ...
       * The prop defaults to the value (`'primary'`) inherited from the parent FormControl component.
       */
      color: import_prop_types10.default.oneOfType([
        import_prop_types10.default.oneOf(['primary', 'secondary']),
       ...
       * Maximum number of rows to display when multiline option is set to true.
       */
      maxRows: import_prop_types10.default.oneOfType([
       ...
       * Minimum number of rows to display when multiline option is set to true.
       */
      minRows: import_prop_types10.default.oneOfType([
        import_prop_types10.default.number,
        import_prop_types10.default.string,
      ]),
      /**
       ...
       * Number of rows to display when multiline option is set to true.
       */
      rows: import_prop_types10.default.oneOfType([
        import_prop_types10.default.number,
        import_prop_types10.default.string,
      ]),
      /**
  ...
  return (0, import_jsx_runtime11.jsx)(NotchedOutlineRoot, {
    ...
    children: (0, import_jsx_runtime11.jsx)(NotchedOutlineLegend, {
      ...
      children: withLabel
        ...
        : // notranslate needed while Google Translate will not fix zero-width space issue
          _span2 ||
          (_span2 = (0, import_jsx_runtime11.jsx)('span', {
            className: 'notranslate',
            'aria-hidden': true,
            children: '​',
          })),
...
var OutlinedInput = React13.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime12.jsx)(InputBase_default, {
    ...
    slotProps,
    renderSuffix: (state) =>
      (0, import_jsx_runtime12.jsx)(NotchedSlot, {
        ...notchedProps,
        notched:
...
true
  ? (OutlinedInput.propTypes = {
       ...
       * The prop defaults to the value (`'primary'`) inherited from the parent FormControl component.
       */
      color: import_prop_types12.default.oneOfType([
        import_prop_types12.default.oneOf(['primary', 'secondary']),
       ...
       * Maximum number of rows to display when multiline option is set to true.
       */
      maxRows: import_prop_types12.default.oneOfType([
       ...
       * Minimum number of rows to display when multiline option is set to true.
       */
      minRows: import_prop_types12.default.oneOfType([
        import_prop_types12.default.number,
        import_prop_types12.default.string,
      ]),
      /**
       ...
       * Number of rows to display when multiline option is set to true.
       */
      rows: import_prop_types12.default.oneOfType([
        import_prop_types12.default.number,
        import_prop_types12.default.string,
      ]),
      /**
      ...
      slotProps: import_prop_types12.default.shape({
        ...
        notchedOutline: import_prop_types12.default.oneOfType([
...
true
  ? (Select.propTypes = {
       ...
       */
      value: import_prop_types13.default.oneOfType([
        import_prop_types13.default.oneOf(['']),
        import_prop_types13.default.any,
      ]),
      /**
       * The variant to use.
       * @default 'outlined'
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-O7XXZBRM.js.map
