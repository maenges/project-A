...
import { useEventCallback_default, useForkRef_default } from './chunk-VIOYBTRK.js';
...
import { styled_default, useTheme } from './chunk-SCZ4OLDJ.js';
import {
  Timeout,
  alpha,
  composeClasses,
...
var Tooltip = React.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const popperOptions = React.useMemo(() => {
    ...
    if (
      (_b = resolvedPopperProps == null ? void 0 : resolvedPopperProps.popperOptions) == null
        ? void 0
        : _b.modifiers
    ) {
  ...
  return (0, import_jsx_runtime.jsxs)(React.Fragment, {
    children: [
      ...
      (0, import_jsx_runtime.jsx)(PopperSlot, {
          ...
          (0, import_jsx_runtime.jsx)(TransitionSlot, {
            ...
            children: (0, import_jsx_runtime.jsxs)(TooltipSlot, {
              ...
              children: [
                title,
                arrow
                  ? (0, import_jsx_runtime.jsx)(ArrowSlot, {
                      ...arrowSlotProps,
                    })
                  : null,
              ],
...
true
  ? (Tooltip.propTypes = {
      ...
      slotProps: import_prop_types.default.shape({
        arrow: import_prop_types.default.oneOfType([
          import_prop_types.default.func,
          import_prop_types.default.object,
        ]),
        popper: import_prop_types.default.oneOfType([
          import_prop_types.default.func,
          import_prop_types.default.object,
        ]),
        tooltip: import_prop_types.default.oneOfType([
          import_prop_types.default.func,
          import_prop_types.default.object,
        ]),
...
export { getTooltipUtilityClass, tooltipClasses_default, Tooltip_default };
//# sourceMappingURL=chunk-DL4UVKNI.js.map
