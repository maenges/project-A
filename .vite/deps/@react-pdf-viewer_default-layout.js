import { require_lib as require_lib3 } from './chunk-QD7VYBMB.js';
import { require_lib as require_lib2 } from './chunk-BLQF5M57.js';
import { require_lib } from './chunk-TRTYORN2.js';
...
var require_attachment = __commonJS({
  'node_modules/@react-pdf-viewer/attachment/lib/cjs/attachment.js'(exports) {
    ...
    var downloadFile = function (url, data) {
      var blobUrl =
        typeof data === 'string' ? '' : URL.createObjectURL(new Blob([data], { type: '' }));
    ...
    var AttachmentList = function (_a) {
      ...
      var clickDownloadLabel =
        l10n && l10n.attachment ? l10n.attachment.clickToDownload : 'Click to download';
  ...
  'node_modules/@react-pdf-viewer/bookmark/lib/cjs/bookmark.js'(exports) {
    ...
    var BookmarkItem = function (_a) {
      ...
      var defaultRenderToggle = function (expandIcon, collapseIcon) {
        return hasSubItems
          ...
          : React__namespace.createElement('span', { className: 'rpv-bookmark__toggle' });
      };
    ...
    var BookmarkListRoot = function (_a) {
      ...
      var toggle = function (toggle2) {
        ...
        if (
          closestItem &&
          closestItem.parentElement.getAttribute('aria-expanded') === expanedAttribute
        ) {
    ...
    var bookmarkPlugin = function () {
      ...
      var BookmarksDecorator = function (props) {
        return React__namespace.createElement(BookmarkListWithStore, {
          isBookmarkExpanded:
            props === null || props === void 0 ? void 0 : props.isBookmarkExpanded,
          renderBookmarkItem:
            props === null || props === void 0 ? void 0 : props.renderBookmarkItem,
          store,
        });
      };
      return {
  ...
  'node_modules/@react-pdf-viewer/thumbnail/lib/cjs/thumbnail.js'(exports) {
                ...
                'div',
                {
                  className: core.classNames({
                    ...
                    'rpv-thumbnail__item--dual-even':
                      viewMode === core.ViewMode.DualPage && pageIndex % 2 === 0,
                    'rpv-thumbnail__item--dual-odd':
                      viewMode === core.ViewMode.DualPage && pageIndex % 2 === 1,
    ...
    var ThumbnailListWithStore = function (_a) {
      ...
      var _f = React__namespace.useState(store.get('rotation') || 0),
        rotation = _f[0],
        setRotation = _f[1];
      var _g = React__namespace.useState(store.get('pagesRotation') || /* @__PURE__ */ new Map()),
        pagesRotation = _g[0],
      ...
      return currentDoc
        ...
        : React__namespace.createElement(
            'div',
            { 'data-testid': 'thumbnail-list__loader', className: 'rpv-thumbnail__loader' },
            React__namespace.useContext(SpinnerContext).renderSpinner()
          );
    };
    var thumbnailPlugin = function (pluginProps) {
      ...
      var CoverDecorator = function (props) {
        return React__namespace.createElement(
          ...
          __assign({}, props, {
            renderSpinner:
              pluginProps === null || pluginProps === void 0 ? void 0 : pluginProps.renderSpinner,
            store,
          })
        );
      };
        ...
        function (props) {
          return React__namespace.createElement(
            ...
            React__namespace.createElement(ThumbnailListWithStore, {
              ...
              renderThumbnailItem:
                props === null || props === void 0 ? void 0 : props.renderThumbnailItem,
              store,
              thumbnailDirection:
                (props === null || props === void 0 ? void 0 : props.thumbnailDirection) ||
        ...
        function (props) {
          return React__namespace.createElement(core.Tooltip, {
            ...
            target: React__namespace.createElement(
              core.MinimalButton,
              { ariaLabel: props.label, isSelected, testId, onClick: props.onClick },
              props.icon
            ),
            content: function () {
              return props.label;
    ...
    var SwitchSelectionModeMenuItem = function (_a) {
      ...
      return React__namespace.createElement(
        ...
        function (props) {
          return React__namespace.createElement(
            core.MenuItem,
            { checked: isSelected, icon: props.icon, testId, onClick: props.onClick },
            props.label
          );
        }
      );
    ...
    var selectionModePlugin = function (props) {
      ...
      return {
        install: function (pluginFunctions) {
          store.update(
            'selectionMode',
            props && props.selectionMode ? props.selectionMode : exports.SelectionMode.Text
          );
  ...
  'node_modules/@react-pdf-viewer/full-screen/lib/cjs/full-screen.js'(exports) {
    ...
    var ExitFullScreenButtonWithTooltip = function (_a) {
      ...
      var exitFullScreenLabel =
        l10n && l10n.fullScreen ? l10n.fullScreen.exitFullScreen : 'Exit full screen';
      return React__namespace.createElement(core.Tooltip, {
    ...
    var EnterFullScreen = function (_a) {
      ...
      var defaultChildren = function (props) {
        return isFullScreen
          ? React__namespace.createElement(ExitFullScreenButtonWithTooltip, {
              onClick: props.onClick,
            })
    ...
    var fullScreenPlugin = function (props) {
      ...
      var getFullScreenTarget =
        (props === null || props === void 0 ? void 0 : props.getFullScreenTarget) ||
        defaultFullScreenTarget;
        ...
        return React__namespace.createElement(
          ...
          function (renderProps) {
            return React__namespace.createElement(
              ...
              __assign({ enableShortcuts: fullScreenPluginProps.enableShortcuts }, renderProps)
            );
          }
        );
      };
  ...
  'node_modules/@react-pdf-viewer/open/lib/cjs/open.js'(exports) {
    ...
    var openPlugin = function (props) {
      ...
      var OpenDecorator = function (props2) {
        return React__namespace.createElement(
          Open,
          __assign({ enableShortcuts: openPluginProps.enableShortcuts }, props2, { store })
        );
      };
...
var require_page_navigation = __commonJS({
  'node_modules/@react-pdf-viewer/page-navigation/lib/cjs/page-navigation.js'(exports) {
    ...
    var CurrentPageInput = function (_a) {
      ...
      var label =
        l10n && l10n.pageNavigation ? l10n.pageNavigation.enterPageNumber : 'Enter a page number';
      return React__namespace.createElement(
        'span',
    ...
    var CurrentPageLabel = function (_a) {
      ...
      return currentDoc
        ? React__namespace.createElement(FetchLabels, { doc: currentDoc }, function (labels) {
            var pageLabel =
              labels.length === numberOfPages && numberOfPages > 0 ? labels[currentPage] : '';
            return render({
              currentPage,
              numberOfPages,
              pageLabel,
    ...
    var GoToPreviousPageButton = function (_a) {
      ...
      var l10n = React__namespace.useContext(core.LocalizationContext).l10n;
      var label =
        l10n && l10n.pageNavigation ? l10n.pageNavigation.goToPreviousPage : 'Previous page';
      return React__namespace.createElement(core.Tooltip, {
    ...
    var ShortcutHandler = function (_a) {
      ...
      var handleKeydown = function (e) {
        ...
        var shouldHandleShortcuts =
          ...
          (document.activeElement && containerEle.contains(document.activeElement));
...
var require_print = __commonJS({
  'node_modules/@react-pdf-viewer/print/lib/cjs/print.js'(exports) {
    ...
    var PrintContainer = function (_a) {
      ...
      return React__namespace.createElement(
        ...
        printStatus === PrintStatus.CheckingPermission &&
          React__namespace.createElement(CheckPrintPermission, { doc, store }),
    ...
    var PrintMenuItem = function (_a) {
      ...
      return React__namespace.createElement(
        core.MenuItem,
        { icon: React__namespace.createElement(PrintIcon, null), testId: 'print__menu', onClick },
        label
      );
    };
    var ShortcutHandler = function (_a) {
    ...
    var printPlugin = function (props) {
      ...
      var PrintDecorator = function (props2) {
        return React__namespace.createElement(
          Print,
          __assign({ enableShortcuts: printPluginProps.enableShortcuts }, props2, { store })
        );
      };
        ...
        var updateSlot = {
          children: React__namespace.createElement(
            ...
            React__namespace.createElement(PrintContainer, {
              ...
              renderProgressBar:
                props === null || props === void 0 ? void 0 : props.renderProgressBar,
  ...
  'node_modules/@react-pdf-viewer/properties/lib/cjs/properties.js'(exports) {
    ...
    var PropertiesModal = function (_a) {
      ...
      var formatDate = function (input) {
        ...
        return date
          ? ''.concat(date.toLocaleDateString(), ', ').concat(date.toLocaleTimeString())
          : '';
      };
      var renderData = function (data) {
        return React__namespace.createElement(
          ...
          React__namespace.createElement(
            ...
            React__namespace.createElement(PropertyItem, {
              label:
                l10n && l10n.properties ? l10n.properties.modificationDate : 'Modification date',
...
var require_scroll_mode = __commonJS({
  'node_modules/@react-pdf-viewer/scroll-mode/lib/cjs/scroll-mode.js'(exports) {
    ...
    var switchScrollMode = function (store, scrollMode) {
      ...
      if (
        (scrollMode === core.ScrollMode.Horizontal || scrollMode === core.ScrollMode.Wrapped) &&
    ...
    var SwitchScrollModeDecorator = function (_a) {
      ...
      switch (mode) {
        case core.ScrollMode.Horizontal:
          label =
            l10n && l10n.scrollMode ? l10n.scrollMode.horizontalScrolling : 'Horizontal scrolling';
        ...
        default:
          label =
            l10n && l10n.scrollMode ? l10n.scrollMode.verticalScrolling : 'Vertical scrolling';
      ...
      return React__namespace.createElement(
        ...
        function (props) {
          return React__namespace.createElement(core.Tooltip, {
            ...
            target: React__namespace.createElement(
              core.MinimalButton,
              { ariaLabel: props.label, isDisabled, isSelected, testId, onClick: props.onClick },
              props.icon
            ),
            content: function () {
              return props.label;
    ...
    var SwitchScrollMode = function (_a) {
      ...
      var isDisabled =
        (mode === core.ScrollMode.Horizontal || mode === core.ScrollMode.Wrapped) &&
        viewMode !== core.ViewMode.SinglePage;
      var defaultChildren = function (props) {
    ...
    var SwitchScrollModeMenuItem = function (_a) {
      ...
      return React__namespace.createElement(
        ...
        function (props) {
          return React__namespace.createElement(
            core.MenuItem,
            { checked: isSelected, icon: props.icon, isDisabled, testId, onClick: props.onClick },
            props.label
          );
        }
      );
  ...
  'node_modules/@react-pdf-viewer/search/lib/cjs/search.js'(exports) {
      ...
      React__namespace.useEffect(
        function () {
          ...
          var highlightEle = container.querySelector(
            '.rpv-search__highlight[data-index="'.concat(matchPosition.matchIndex, '"]')
          );
          if (!highlightEle) {
            return;
          }
          var _a2 = calculateOffset(highlightEle, container),
            left = _a2.left,
            top = _a2.top;
    ...
    var useSearch = function (store) {
      ...
      var jumpToMatch = function (index) {
        ...
        var normalizedIndex =
          index === numMatches + 1 ? 1 : Math.max(1, Math.min(numMatches, index));
    ...
    var ShowSearchPopoverButton = function (_a) {
      ...
      return React__namespace.createElement(ShowSearchPopoverDecorator, { onClick }, function (p) {
        return React__namespace.createElement(core.Tooltip, {
          ...
          target: React__namespace.createElement(
            core.MinimalButton,
            { ariaKeyShortcuts, ariaLabel: p.label, testId: 'search__popover-button', onClick },
            p.icon
          ),
          content: function () {
            return p.label;
    ...
    var ShowSearchPopover = function (_a) {
      ...
      var defaultChildren = function (props) {
        return React__namespace.createElement(
          ...
          __assign({ enableShortcuts, store }, props)
        );
      };
      var render = children || defaultChildren;
    ...
    var searchPlugin = function (props) {
      var searchPluginProps = React__namespace.useMemo(function () {
        return Object.assign(
          {},
          { enableShortcuts: true, onHighlightKeyword: function () {} },
          props
        );
      }, []);
      var store = React__namespace.useMemo(function () {
        return core.createStore({
          initialKeyword:
            props && props.keyword
              ...
              : [],
          keyword:
            props && props.keyword ? normalizeKeywords(props.keyword) : [EMPTY_KEYWORD_REGEXP],
          matchPosition: {
            matchIndex: -1,
            pageIndex: -1,
          },
      ...
      var ShowSearchPopoverDecorator2 = function (props2) {
        return React__namespace.createElement(
          ShowSearchPopover,
          __assign({ enableShortcuts: searchPluginProps.enableShortcuts }, props2, { store })
        );
      };
      var ShowSearchPopoverButtonDecorator = function () {
        return React__namespace.createElement(ShowSearchPopoverDecorator2, null, function (props2) {
          return React__namespace.createElement(
            ShowSearchPopoverButton,
            __assign({ enableShortcuts: searchPluginProps.enableShortcuts, store }, props2)
          );
        });
      };
      var renderViewer = function (renderViewerProps) {
  ...
  'node_modules/@react-pdf-viewer/theme/lib/cjs/theme.js'(exports) {
    ...
    var SwitchThemeButton = function (_a) {
      ...
      return React__namespace.createElement(core.Tooltip, {
        ...
        target: React__namespace.createElement(
          core.MinimalButton,
          { ariaLabel: label, testId: 'theme__switch-button', onClick },
          isDarkTheme
...
var require_toolbar = __commonJS({
  'node_modules/@react-pdf-viewer/toolbar/lib/cjs/toolbar.js'(exports) {
    'use strict';
    var core = require_lib();
    var selectionMode = require_lib7();
    var React = require_react();
...
var require_default_layout = __commonJS({
  'node_modules/@react-pdf-viewer/default-layout/lib/cjs/default-layout.js'(exports) {
    ...
    var core = require_lib();
    var React = require_react();
    var attachment = require_lib4();
    var bookmark = require_lib5();
    var thumbnail = require_lib6();
              ...
              'div',
              {
                ...
                className: core.classNames({
                  ...
                  'rpv-default-layout__main--rtl':
                    renderProps.themeContext.direction === core.TextDirection.RightToLeft,
                }),
              },
