import { require_dayjs_min } from './chunk-UQRJFJHE.js';
    ...
    !(function (e, t) {
      'object' == typeof exports && 'undefined' != typeof module
        ...
        : 'function' == typeof define && define.amd
          ? define(t)
          : ((e =
              'undefined' != typeof globalThis ? globalThis : e || self).dayjs_plugin_weekOfYear =
              t());
    })(exports, function () {
      'use strict';
      var e = 'week',
...
var AdapterDayjs = class {
  constructor({ locale: _locale, formats } = {}) {
    ...
    this.isSame = (value, comparing, comparisonTemplate) => {
      ...
      return (
        value.format(comparisonTemplate) === comparingInValueTimezone.format(comparisonTemplate)
      );
    };
    ...
    this.expandFormat = (format) => {
      ...
      const t = (formatBis) =>
        formatBis.replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g, (_, a, b) => a || b.slice(1));
