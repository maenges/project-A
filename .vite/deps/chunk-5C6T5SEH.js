...
var styles = (theme, enableColorScheme = false) => {
  ...
  const themeOverrides =
    (_b = (_a = theme.components) == null ? void 0 : _a.MuiCssBaseline) == null
      ? void 0
      : _b.styleOverrides;
  if (themeOverrides) {
...
function CssBaseline(inProps) {
  ...
  return (0, import_jsx_runtime.jsxs)(React.Fragment, {
    children: [
      isDynamicSupport &&
        (0, import_jsx_runtime.jsx)(GlobalStyles, {
          enableColorScheme,
        }),
      !isDynamicSupport &&
        !enableColorScheme &&
...
export { html, body, CssBaseline_default };
//# sourceMappingURL=chunk-5C6T5SEH.js.map
