import { Typography_default } from './chunk-ELPKKK5T.js';
...
import { composeClasses, generateUtilityClass, generateUtilityClasses } from './chunk-4AUH2Y2D.js';
...
var InputAdornment = React.forwardRef(function InputAdornment2(inProps, ref) {
  ...
  if (variantProp && muiFormControl.variant) {
    if (true) {
      if (variantProp === muiFormControl.variant) {
        console.error(
          'MUI: The `InputAdornment` variant infers the variant prop you do not have to provide one.'
        );
      }
    }
  }
              ...
              children: [
                position === 'start'
                  ? /* notranslate needed while Google Translate will not fix zero-width space issue */
                    _span ||
                    (_span = (0, import_jsx_runtime.jsx)('span', {
...
export { getInputAdornmentUtilityClass, inputAdornmentClasses_default, InputAdornment_default };
//# sourceMappingURL=chunk-5EV6455O.js.map
