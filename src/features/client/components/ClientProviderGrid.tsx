...
const ClientProviderGrid = ({ tab }: Props) => {
  ...
  const slotCards: Array<(typeof casinoCards)[number] & { gameKey?: string }> = [
    ...
    // { name: 'spinomenal', gameKey: 'spinomenal', sub: '스피노메날' },
    // { name: 'fc_arcade', gameKey: 'fc_arcade', sub: 'FC 아케이드' },
    // { name: 'fc_slot', gameKey: 'fc_slot', sub: 'FC 슬롯' },
    // { name: 'jdb', gameKey: 'jdb', sub: 'JDB 슬롯' },
    // { name: 'pgsoft', gameKey: 'pgsoft', sub: 'PG 소프트' },
    // { name: 'evoplay', gameKey: 'evoplay', sub: '이보플레이' },
    // { name: 'yellowbat', gameKey: 'yellowbat', sub: '옐로우배트' },
    // { name: 'gtf', gameKey: 'gtf', sub: 'GTF' },
    // { name: 'spade', gameKey: 'spade', sub: '스페이드게이밍' },
    // { name: 'advantplay', gameKey: 'advantplay', sub: '어드밴트플레이' },
    // { name: 'askmeslot', gameKey: 'askmeslot', sub: '아스크미슬롯' },
    // { name: 'bgaming', gameKey: 'bgaming', sub: '비게이밍' },
    // { name: 'booming', gameKey: 'booming', sub: '부밍게임즈' },
    // { name: 'dbgame', gameKey: 'dbgame', sub: 'DB 게임' },
    // { name: 'thunderkick', gameKey: 'thunderkick', sub: '썬더킥' },
  ];
